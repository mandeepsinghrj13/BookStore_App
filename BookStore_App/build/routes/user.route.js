...
router.post('/user', (0, _user3.setRole)('user'), _user2.registerValidator, userController.register); //route to create a new admin registration

router.post('/admin', (0, _user3.setRole)('admin'), userController.register);
var _default = router;
